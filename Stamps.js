...
const QRCodeScanner = ({ navigation }) => {
  ...
  useEffect(() => {
    (async () => {
      await AsyncStorage.setItem('scannedDataArray', JSON.stringify(Array.from(scannedDataSet)));
    })();
...
const Stamps = ({ navigation }) => {
  ...
  useEffect(() => {
    (async () => {
      ...
      const parsedArray = storedScannedDataArray ? new Set(JSON.parse(storedScannedDataArray)) : new Set();
                            ...
                            <ImageBackground source={require('./assets/stampsPlaceholder.png')} style={{width: '100%', height: '100%',}} >
                                ...
                                {!stamp1 &&                                
                                  ...
                                  >
                                    ...
                                    <Svg xmlns="http://www.w3.org/2000/svg" width="25" height="50" viewBox="0 0 24 27" fill="none">
