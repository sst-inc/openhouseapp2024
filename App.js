...
function CustomDrawerContent(props) {
  return (
    <DrawerContentScrollView {...props}>
      <Text
        style={{fontSize: 30, margin: 10, color: 'white', fontWeight: '600'}}>
        {' '}
        SST{'\n'} Open House
      </Text>
